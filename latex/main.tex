...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Este modelo de apresentação foi criado
% a partir do modelo de Giovanni Spadaro.
% Disponível em:
% https://github.com/Giovo17/presentation-template-unict-lm-data
%
% e adaptado por Lucas Amaral Taylor para criar uma versão especial 
...
\include{sections/Section00} % Seção 00
\include{sections/Section01} % Seção 01
\include{sections/Section02} % Seção 02
