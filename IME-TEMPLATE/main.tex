...
\definecolor{primaryColor}{RGB}{20,45,105} % Cor primária para ser usada no cabeçalho e outros elementos
...
% Definição da cor primária no cabeçalho
...
\setbeamercolor{author in head/foot}{bg=secondaryColor, fg=white} % NOME
\setbeamercolor{title in head/foot}{bg=primaryColor, fg=white} % Título
\setbeamercolor{date in head/foot}{bg=secondaryColor, fg=white} % Ano
